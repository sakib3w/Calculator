...
function App() {
  ...
  useEffect(() => {
    const sendMessage = () => {
      window.parent.postMessage([number, string], "http://localhost:3000");
    };
    sendMessage();
  }, [number, string]);
  ...
  const handleClick = (val) => {
    ...
    // check and set values to the respective states
      ...
      <div className="calculator-main-body">
        <div className="calculator--body">
          <div className="calculator--body--display">
            <input value={value} readOnly placeholder="Child" />
            {/* <input value={recievedMessage} /> */}
          </div>
